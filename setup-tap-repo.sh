...
Homebrew tap for [Claude Code Personalities](https://github.com/kumamaki/claude-code-personalities).
...
brew untap kumamaki/claude-code-personalities  # if you used tap method
```

## Documentation

See the [main repository](https://github.com/kumamaki/claude-code-personalities) for full documentation.
...
echo -e "Repository: ${CYAN}https://github.com/kumamaki/$TAP_REPO${NC}"
echo
echo -e "${BOLD}Users can now install with:${NC}"
echo -e "  ${CYAN}brew tap kumamaki/claude-code-personalities${NC}"
...
echo -e "     ${CYAN}https://github.com/kumamaki/$TAP_REPO/settings/keys${NC}"
echo -e "  3. Add private key as secret TAP_DEPLOY_KEY in main repo:"
echo -e "     ${CYAN}https://github.com/kumamaki/claude-code-personalities/settings/secrets/actions${NC}"