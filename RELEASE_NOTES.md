...
- [x] Replace placeholder GitHub username with kumamaki
...
2. **Create GitHub Release**:
   - Go to https://github.com/kumamaki/claude-code-personalities/releases/new
   - Choose tag: v1.1.0
...
3. **Update Homebrew Formula**:
   ...
   ```bash
   curl -L https://github.com/kumamaki/claude-code-personalities/archive/v1.1.0.tar.gz | shasum -a 256
   ```
...
## 🙏 Credits
Created for Claude Code by kumamaki