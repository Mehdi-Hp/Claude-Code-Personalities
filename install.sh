...
if [[ $? -eq 0 ]]; then
    ...
    if [[ -f "$SCRIPT_DIR/scripts/statusline.sh" ]]; then
        ...
        curl -fsSL "https://raw.githubusercontent.com/kumamaki/claude-code-personalities/main/scripts/statusline.sh" \
...
if [[ $? -eq 0 ]]; then
    ...
    if [[ -f "$SCRIPT_DIR/hooks/personalities_track_activity.sh" ]]; then
        ...
        curl -fsSL "https://raw.githubusercontent.com/kumamaki/claude-code-personalities/main/hooks/personalities_track_activity.sh" \
    ...
    if [[ -f "$SCRIPT_DIR/hooks/personalities_reset_errors.sh" ]]; then
        ...
        curl -fsSL "https://raw.githubusercontent.com/kumamaki/claude-code-personalities/main/hooks/personalities_reset_errors.sh" \
    ...
    if [[ -f "$SCRIPT_DIR/hooks/personalities_session_end.sh" ]]; then
        ...
        curl -fsSL "https://raw.githubusercontent.com/kumamaki/claude-code-personalities/main/hooks/personalities_session_end.sh" \
