...
mod tests {
    ...
    fn test_get_options() {
        ...
        assert!(options.iter().any(|(name, _)| *name == "Show Current Job/File"));
        assert!(options.iter().any(|(name, _)| *name == "Show Current Directory"));
        assert!(options.iter().any(|(name, _)| *name == "Show Model Indicator"));
        assert!(options.iter().any(|(name, _)| *name == "Show Error Indicators"));
    ...
    async fn test_save_and_load() {
        ...
        assert_eq!(loaded_prefs.show_current_dir, true);
