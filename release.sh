...
if command -v gh &> /dev/null; then
    ...
    echo "https://github.com/kumamaki/claude-code-personalities/releases/new"
    echo ""
    echo "Tag: $TAG"
    echo ""
    echo "Release notes:"
...
echo "  curl -fsSL https://raw.githubusercontent.com/kumamaki/claude-code-personalities/main/install.sh | bash"
echo ""
